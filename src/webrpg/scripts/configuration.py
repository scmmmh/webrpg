"""
###############################################################
:mod:`~webrpg.scripts.configuration` - Configuration generation
###############################################################

Implements the configuration generation functionality.
...
def init(subparsers):
    """Adds the sub-parser for the configuration generation."""
